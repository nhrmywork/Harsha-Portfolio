...
const Home = () => {
  ...
  return (
    <div
      className="min-h-screen transition-colors duration-300 dark:bg-gray-900 dark:text-white bg-cover bg-center bg-no-repeat bg-fixed"
      style={{ backgroundImage: "var(--bg-image)" }}
    >
      <style>
        {`
            :root {
              --bg-image: url('/3d-interior-home.jpg');
            }
            .dark {
              --bg-image: none;
            }
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-20 gap-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold leading-tight">
            Hi, I'm
            {/* <span className="text-night dark:text-sand-shadow">Harshavardhan Reddy Nagarthi</span> */}
            <span>
              <img
                src="../public/Nagarthi Harshavardhan Reddy - silver.svg"
                alt="Harshavardhan Reddy Nagarthi"
